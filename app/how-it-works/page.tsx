          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                Our platform is designed to be intuitive and easy to use, even for those
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                Automate routine tasks and focus on growing your business instead of
                managing paperwork.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                Make informed decisions with real-time insights and comprehensive
                analytics.
              </p>
            </div>
          </div>

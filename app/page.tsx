        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Transform your business with our comprehensive suite of tools for analytics,
              sales tracking, and digital payments.
            </p>
            <Link
              href="/contact"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-6 bg-white rounded-lg shadow-lg">
            ...
            <h3 className="text-xl font-semibold mb-2">Sales & Expense Tracking</h3>
            <p className="text-gray-600">
              Keep track of your business finances with our intuitive tracking tools.
            </p>
          </div>
